...
def image_viewer_page():
    ...
    # Load image
    image_path = f"/media/chuv/T7/IMAGE/{selected_time_point}/DESS_{selected_time_point}/{selected_id}_*_SAG_3D_DESS_LEFT_0000.nii.gz"
    ...
    # Load mask
    mask_path = f"/media/chuv/T7/DATA/pred/pred_{selected_time_point.lower()}_PP/{selected_id}_*_SAG_3D_DESS_LEFT.nii.gz"
